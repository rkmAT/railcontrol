...
/* TextConnectionLost */ { "TCP Connection lost. Error: {0}", "TCP Verbindung abgebrochen. Fehlercode: {0}", "" },
...
/* TextHintDCCpp */ { "Use for DCC++ and DCC++EX cetral stations.<br>Default IP port is 2560.<br>Under Linux the virtual serial port is usually /dev/ttyUSB0.", "Nutzbar für DCC++ und DCC++ EX Zentralen.<br>Standard IP Port ist 2560.<br>Unter Linux ist der erstellte virtuelle COM-Port üblicherweise /dev/ttyUSB0.", "DCC++ES" },
...
/* TextReceiverThreadHeartbeat */ { "Heartbeat thread started", "Heartbeat-Thread gestartet", "Thread recibiendo creado" },
